...
-------------------------------------------------------------------------------------------
INSERT INTO ITEMS_REF_SILVER (ITEM_ID, ITEM_NAME, ITEM_CATEGORY)
VALUES
    (2510, 'Dusk and Dawn', 'Legendary'),
    (8010, 'Bloodletter''s Curse', 'Legendary'),
    (3097, 'Stormrazor', 'Legendary'),
    (2517, 'Endless Hunger', 'Legendary'),
    (2525, 'Protoplasm Harness', 'Legendary'),
    (2522, 'Actualizer', 'Legendary'),
    (2526, 'Whispering Circlet', 'Legendary'),
    (3340, 'Stealth Ward', 'Trinket'),
    (2524, 'Bandlepipes', 'Legendary'),
    (2512, 'Fiendhunter Bolts', 'Legendary'),
    (2523, 'Hexoptics C44', 'Legendary'),
    (2520, 'Bastionbreaker', 'Legendary');
