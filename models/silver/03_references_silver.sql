...
SELECT
    ...
    NULLIFY_CAPLEN(ITEM_NAME, 255) AS ITEM_NAME,
    NULLIFY_CAPLEN(ITEM_CATEGORY, 255) AS ITEM_CATEGORY
...
SELECT
    ...
    NULLIFY_CAPLEN(PASCAL_TO_TITLE_CASE(CHAMPION_NAME), 64) AS CHAMPION_NAME
